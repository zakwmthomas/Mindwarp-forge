...
closed with no C4V work remaining active. Owner-authorized GP3 is promoted and
closed after registered gate `run-50a8c78043eb46c483f1f655d3793f9b`; GP4 depends on both GP3 and C4V but remains owner-gated. C3A exposes the exact validated causal-world seam needed downstream;
