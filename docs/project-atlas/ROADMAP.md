...
closed after registered gate `run-50a8c78043eb46c483f1f655d3793f9b`. GP4 is verified after registered gate `run-7e5c44dc8f48424a8cec42da756e3127`, and its exact typed bounded vertical-closeout receipt is recorded as the sole active evidence item; broad G1-CLOSEOUT and runtime selection remain gated. C3A exposes the exact validated causal-world seam needed downstream;
