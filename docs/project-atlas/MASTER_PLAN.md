...
- **C6** - executing; gate: design; depends on: C4, C5.
  Next: Stop at the verified package-4 ecological-niche semantics design/readiness boundary. One separately owner-authorized test-first implementation of the frozen V1 candidate and its single additive consumer is the next candidate; do not activate it automatically.
