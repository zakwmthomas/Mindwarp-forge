...
- **C6** - executing; gate: design; depends on: C4, C5.
  Next: Complete and verify the active code-free package-4 ecological-niche semantics authored-hypothesis design/readiness package. Freeze its atomic strict contract, typed indeterminacy, exact resource/codec/one-consumer/rollback boundary and stop before production source.
