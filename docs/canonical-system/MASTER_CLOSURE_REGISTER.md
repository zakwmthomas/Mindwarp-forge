...
- Broad C4 and capability-free C5 are verified, complete and recorded. C6 body-plan structure V1, organism-subject identity V1 and the package-4 ecological-niche source-negative schema-gap audit are verified and recorded; the separate authored-hypothesis design/readiness candidate and every implementation/later C6 package remain gated. GP0-GP4 and `G1-VERTICAL-CLOSEOUT` remain completed immutable evidence; C7, broad `G1-CLOSEOUT` and R1 remain gated and unchanged. C5 grants no broader C6 authority.
