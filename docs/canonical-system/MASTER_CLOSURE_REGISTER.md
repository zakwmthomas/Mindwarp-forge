...
- C4 depends on C2 and C3A only. GP0 is structurally verified without gameplay-system promotion; GP1 is independently and completely verified as a capability-free fixed-loop proof; GP2 is the sole active design-intake item and GP3-GP4 remain dependency-gated.
