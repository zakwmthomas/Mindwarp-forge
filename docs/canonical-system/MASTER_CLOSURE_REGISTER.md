...
| C6 | Semantic/construction and organism ecology | Causal/diversity/replay/validator tests | Code-free C6 reconciliation/readiness is active against verified C4-C5; implementation remains gated. The corrected plan freezes 82 exact hostile IDs, a coordinate-free variation-capable body-plan precursor, and explicit reproduction/development/heredity/applicability work. Full niches, anatomy, physiology, species/ecomorphs, population semantics, applicable dimorphism, comparison and aesthetic grammar remain open |
