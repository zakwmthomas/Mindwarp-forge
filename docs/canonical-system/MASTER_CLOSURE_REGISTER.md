...
| C5 | Significance/scheduler | Pressure/cancellation/starvation/thrash tests | Reconciled readiness: 18 retained focused tests pass, but all eight typed domains, packet-derived priority binding, same-domain fallback, state-gated completion, strict trace replay and capability-free residency lease/thrash proof remain open. Exact hostile registry is frozen; implementation source is not yet authorized |
