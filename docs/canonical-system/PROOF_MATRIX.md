...
| C5 | Eight typed domain maps plus packet-derived priority, dispatch, admission, budget, typed fallback, cancellation, fairness/starvation, thrash, capability-free residency leases and strict trace replay without canonical truth forks | Reconciled readiness; retained 18-test prototype passes but complete named-domain and hostile proof remains open |
