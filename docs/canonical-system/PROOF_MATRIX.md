...
| C6 | Ecological niche, lineage/evolution, body-plan structure, physiology/viability, reproduction/development/heredity, organism/species/population, ecomorph, grounded sense/capacity, applicable variation, comparative person-form, aging distribution and nonvisual intent proof | Code-free readiness active against verified C4-C5; 38 focused prototype tests are reconciled as partial non-closure evidence; 82 exact hostile IDs across 13 domains and a separately gated variation-capable body-plan first candidate are frozen in `G1_C6_CLOSURE_READINESS.md` |
