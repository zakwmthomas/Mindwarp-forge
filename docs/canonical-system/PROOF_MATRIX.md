...
| C6 | Ecological niche, lineage/evolution, body-plan structure, physiology/viability, organism/species/population, ecomorph, grounded sense/capacity, comparative person-form, applicable variation, aging distribution and nonvisual intent proof | Code-free readiness active against verified C4-C5; 38 focused prototype tests are reconciled as partial non-closure evidence; 68 hostiles across 12 domains and a separately gated body-plan first candidate are frozen in `G1_C6_CLOSURE_READINESS.md` |
