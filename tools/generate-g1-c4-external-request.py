#!/usr/bin/env python3
"""Generate one fresh authority-negative C4 independent-run request."""
...
def main() -> None:
    ...
    if run("git","status","--porcelain"):
        raise SystemExit("C4 external request requires a clean tree")
    ...
    request={
      ...
      "provenance_policy":{"repository":args.github_repository,"workflow_path":".github/workflows/g1-c4-independent-platform.yml","signer_workflow":f"{args.github_repository}/.github/workflows/g1-c4-independent-platform.yml"},
    ...
    print(f"C4 external request generated: {request['request_id']} {request['request_sha256']}")
