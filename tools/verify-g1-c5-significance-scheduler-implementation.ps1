...
$test=Get-Content (Join-Path $crate 'tests\eight_domain_scheduler_closure.rs') -Raw
...
Write-Output 'G1 C5 local implementation candidate verified: typed eight-domain surface, 27 tests, exact 92-ID registry identity and capability-negative boundary pass. This does not claim all 92 hostiles or closure.'
