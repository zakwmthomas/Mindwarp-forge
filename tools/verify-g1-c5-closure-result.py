...
SUCCESSOR = "5f934a61dff9effa0fec1a7c219f53e3a510faa715e1e4c58622fd7a5585715c"
...
def verify(root: Path) -> None:
    ...
    successor = c6_readiness or c6_body_plan
    expected = ({
    ...
    if successor and c6.get("gate") != ("implementation" if c6_body_plan else "design"): raise ValueError("C6 successor gate drifted")
