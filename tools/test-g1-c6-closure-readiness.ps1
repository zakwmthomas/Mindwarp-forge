...
Must-Fail 'implementation authority' {$p=Get-Content $checkpoint -Raw|ConvertFrom-Json;$p.authority_lane+=' forged';$p|ConvertTo-Json -Depth 100|Set-Content $checkpoint -Encoding utf8}
