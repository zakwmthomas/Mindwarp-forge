...
if(!(Test-G1C6OrganismSubjectIdentityImplementationRoute -Checkpoint $checkpoint)-and!(Test-G1C6EcologicalNicheSemanticsSchemaGapRoute -Checkpoint $checkpoint)-and!(Test-G1C6EcologicalNicheSemanticsDesignReadinessRoute -Checkpoint $checkpoint)){throw 'C6 organism-subject identity implementation or exact recorded successor route is not exact.'}
