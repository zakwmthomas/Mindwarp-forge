...
try{
 ...
 Expect-Failure 'successor manifest drift' { $p=Join-Path $temp 'docs/canonical-system/G1_C5_CLOSURE_RESULT.md';(Get-Content $p -Raw).Replace('97da3aed932d41f7a0c4569585f38ccc1fba6e0a0b2e6136137d7f648b41dacd',('f'*64))|Set-Content $p -Encoding utf8 }
