...
foreach($token in @('38 tests','`semantic-construction` 14','`organism-niche-binding` 5','`niche-graph-binding` 7','`macro-lineage-binding` 6','`person-form-eligibility` 6','C3 physical opportunity and coavailability precursor','structural binding completeness only','C6-H000..003','C6-H100..105','C6-H200..205','C6-H300..306','C6-H400..405','C6-H500..505','C6-H600..605','C6-H700..705','C6-H800..805','C6-H900..904','C6-H1000..1004','C6-H1100..1108','C6-H1200..1209','exactly 82 IDs','Biological sex, reproductive role','third structurally withheld morphology','approved paired humanoid model','This readiness record does not authorize source','Nothing broader is locked in')){if(!$text.Contains($token)){throw "C6 readiness token missing: $token"}}
