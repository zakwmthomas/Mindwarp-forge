...
if($active.Count-ne1-or$active[0].id-ne'C5'-or$checkpoint.batch_id-ne'G1-C5-SIGNIFICANCE-SCHEDULER-CLOSURE-V1'-or$checkpoint.master_program_item-ne'C5'-or$checkpoint.substage_id-notin@('c5-reconciliation-readiness','c5-implementation-owner-gate')-or$checkpoint.authority_lane-ne$requiredAuthority){throw 'C5 checkpoint route or authority is not exact.'}
