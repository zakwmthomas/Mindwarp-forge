...
if($state.state-ne'executing'-or$state.substage_id-ne'c4-independent-platform-gate'-or$state.context_health-notmatch'candidate_verified_local'-or$state.next_action-notmatch'hosted Ubuntu workflow'){throw 'C4 retained checkpoint state changed.'}
